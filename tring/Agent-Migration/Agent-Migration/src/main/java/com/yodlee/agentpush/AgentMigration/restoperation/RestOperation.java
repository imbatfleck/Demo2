...
public class RestOperation {
	...
	public <T,M> M getPostResponseEntity(T requestObject,M responseObject,RestTemplate restTemplate)
	{
		ResponseEntity<M> responseData=(ResponseEntity<M>) restTemplate.postForEntity("https://agent-migration.tools.yodlee.com/site-agent/deployment/login", requestObject, responseObject.getClass());
		return responseData.getBody();
	}
